...
-- 샘플 사용자 3명 추가
INSERT INTO users (email, password_hash, provider, provider_id, name) VALUES
('user1@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'local', NULL, '김철수'),  -- 비밀번호: password123
('user2@example.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'local', NULL, '이영희'),  -- 비밀번호: password123
